...
void DrawTextPB(RGBABitmapImage *canvas, double x, double y, std::vector<wchar_t> *text, RGBA *color);
...
std::vector<wchar_t> *CreateStringDecimalFromNumber(double decimal, int timeType);
